...
require 'database.php';
    ...
    if ( !empty($_POST)) {
        ...
        if(empty($sexo)){
            $sexoError = "Por favor insira sexo";
            $valid= false;
        }
         if(empty($dataN)){
            $dataNError = "Sem data de Nascimento";
            $valid= false;
        }
        ...
        if ($valid) {
            ...
            $sql = "INSERT INTO usuario (nome,email,celular,sexo,dataN) values(?, ?, ?,?,?)";
            $q = $pdo->prepare($sql);
            $q->execute(array($nome,$email,$celular,$sexo,$dataN));
            Database::disconnect();
                ...
                <div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="criar.php" method="post">
                      ...
                      <div class="control-group <?php echo !empty($sexoError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="sexo" type="radio"  placeholder="sexo" value="Masculino" checked>Masculino
                            <input name="sexo" type="radio"  placeholder="sexo" value="Feminino">Feminino
